...
class LoginPage(BasePage.BasePage):
	...
	sLoginButton=(By.NAME,"bt_login")
	sUserName=(By.ID,"validateUserId_loginName")
	...
	def __login(self,userName):
		...
		self.findElementBy(self.sUserName).send_keys(userName)
		self.findElementBy(self.sLoginButton).click()
		return self
